...
export default () => (
    <div>
        <HeaderFooter>
            ...
            {/* Hero area */}
            <section className={`${indexStyles.heroArea} bg-white px-5 position-relative`}>
                <Container>
                    <Row>
                        ...
                        <Col md={6} className="d-none d-md-flex justify-content-end">
                           <img alt="korean society lion" width="400" src={modified_logo}></img>
                        </Col>
                    </Row>
                </Container>
                <ul className="ml-5 mt-3 list-unstyled">
                    <li className="mb-3"><a href="https://www.facebook.com/groups/258391824278076/"><img alt="facebook" src={facebook}/></a></li>
                        ...
                        <Col lg={6} md={6} className={indexStyles.mb80}>
                            <div className="d-flex">
                                <div className="mr-lg-5 mr-3">
                                    <img className="shadow d-block rounded-circle bg-white p-3" width="100" src={medal} />
                                </div>
                                <div>
                                    <p className="text-dark mb-1">2006</p>
                                        <h4>Marters in UX Design</h4>
                                    <p className="mb-0 text-muted">Masassusets Institute of Technology</p>
                                </div>
                            </div>
                        </Col>
                         <Col lg={6} md={6} className={indexStyles.mb80}>
                ...
                <Container>
                    <Row>   
                        ...
                        <Col md={4} className="mb-4 mb-md-0">
                            <Card className={`${indexStyles.hoverShadow} shadow`}>
                                <Card.Body className="text-center px-4 py-5">
                                    <img className="mb-5 d-inline-block" width="50" src={camera} />
                        ...
                        <Col md={4} className="mb-4 mb-md-0">
                            <Card className="hover-shadow shadow">
                                <Card.Body className="text-center px-4 py-5">
                                    <img className="mb-5 d-inline-block" width="50" src={basketball} />
